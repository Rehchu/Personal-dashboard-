...
const DEFS = [
  { id: 'first-rep', name: 'First Rep', desc: 'Log your first workout.', test: d => d.workouts.length >= 1 },
  { id: 'reps-10', name: 'Putting In Reps', desc: 'Log 10 workouts.', test: d => d.workouts.length >= 10 },
  { id: 'streak-3', name: 'On A Roll', desc: 'Work out on 3 different days.', test: d => new Set(d.workouts.map(w => w.date)).size >= 3 },
  { id: 'trend-5', name: 'Trend Watcher', desc: 'Record 5 weigh-ins.', test: d => d.weights.length >= 5 },
  { id: 'words-1k', name: 'Chapter One', desc: 'Write 1,000 words across your books.', test: d => d.words >= 1000 },
  { id: 'words-10k', name: 'Momentum', desc: 'Write 10,000 words across your books.', test: d => d.words >= 10000 },
  { id: 'words-50k', name: 'Half A Dragon', desc: 'Write 50,000 words across your books.', test: d => d.words >= 50000 },
  { id: 'chapters-5', name: 'The Plot Thickens', desc: 'Create 5 chapters in total.', test: d => d.chapters >= 5 },
  { id: 'first-ink', name: 'First Stroke', desc: 'Draw anything in the notebook.', test: d => d.inked >= 1 },
